...
d3.csv("data/4-10M_(1995-today).csv")
  .then((data) => {
    ...
    // Example: Initialize with Jan 2015 – March 2016
    ...
    monthLabel.textContent = latestMonth.toLocaleString("default", {
      month: "short",
      year: "numeric",
    });
    ...
    monthSlider.addEventListener("input", function () {
      ...
      monthLabel.textContent = selectedMonth.toLocaleString("default", {
        month: "short",
        year: "numeric",
      });
...
function drawBarChart(container, dataObj, color, hoverColor, title, xLabel) {
  ...
  svg
    ...
    .on("mouseover", function (event, d) {
      ...
      d3.select("#tooltip").style("opacity", 1).style("z-index", 1000000).html(`
